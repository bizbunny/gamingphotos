...
let mArray = [
  ...
  { id: "Xavier16", src: "./static/loveanddeepspace/Paper17317286152.png", modal: "modal80", label: "Cat Xavier 4", data: "xavier cat"},
  { id: "Xavier17", src: "./static/loveanddeepspace/Paper17323305101.png", modal: "modal81", label: "Cat Xavier 5", data: "xavier cat"},
  { id: "Xavier18", src: "./static/loveanddeepspace/Paper17323305132.png", modal: "modal82", label: "Cat Xavier 6", data: "xavier cat"},
  { id: "Rafayel24", src: "./static/loveanddeepspace/Paper17323305153.png", modal: "modal83", label: "Cat Rafayel lean in", data: "rafayel cat"},
  { id: "Rafayel25", src: "./static/loveanddeepspace/Paper17323305174.png", modal: "modal84", label: "Cat Rafayel talking", data: "rafayel cat"},
  { id: "Sylus23", src: "./static/loveanddeepspace/Paper17323305205.png", modal: "modal85", label: "Cat Sylus lean in 3", data: "sylus cat"},
  { id: "Sylus24", src: "./static/loveanddeepspace/Paper17323305226.png", modal: "modal86", label: "Cat Sylus close up 1", data: "sylus cat"},
  { id: "Sylus25", src: "./static/loveanddeepspace/Paper17323305257.png", modal: "modal87", label: "Cat Sylus close up 2", data: "sylus cat"},
  { id: "Sylus26", src: "./static/loveanddeepspace/Paper17323305288.png", modal: "modal88", label: "Cat Sylus standing 2", data: "sylus cat"},
  { id: "Sylus27", src: "./static/loveanddeepspace/Paper17336106851.png", modal: "modal89", label: "Sylus Collage 2", data: "sylus collage"},
  { id: "Sylus28", src: "./static/loveanddeepspace/Paper17336107312.png", modal: "modal90", label: "Sylus sunglasses & stickers", data: "sylus"},
  { id: "MC9", src: "./static/loveanddeepspace/Paper17336108023.png", modal: "modal91", label: "MC Roar", data: "mc"},
  { id: "Sylus29", src: "./static/loveanddeepspace/Paper17336108754.png", modal: "modal92", label: "Sylus lean down", data: "sylus"},
  { id: "Sylus30", src: "./static/loveanddeepspace/Paper17336109225.png", modal: "modal93", label: "Sylus finger guns", data: "sylus"},
  { id: "Rafayel26", src: "./static/loveanddeepspace/Paper17372529281.png", modal: "modal94", label: "Rafayel Collage 2", data: "rafayel collage"},
  { id: "Rafayel27", src: "./static/loveanddeepspace/Paper17372530332.png", modal: "modal95", label: "Rafayel Artsy Look + Crown", data: "rafayel"},
  { id: "MC10", src: "./static/loveanddeepspace/Paper17372531613.png", modal: "modal96", label: "MC Wink", data: "mc"},
  { id: "Rafayel28", src: "./static/loveanddeepspace/Paper17372532874.png", modal: "modal97", label: "Rayel chin touch", data: "rafayel"},
  { id: "Rafayel29", src: "./static/loveanddeepspace/Paper17372533445.png", modal: "modal98", label: "Rafayel head rest", data: "rafayel"},
  { id: "Caleb1", src: "./static/loveanddeepspace/Paper17376009001.png", modal: "modal99", label: "Caleb Collage", data: "caleb collage"},
  { id: "Caleb2", src: "./static/loveanddeepspace/Paper17376010062.png", modal: "modal100", label: "Caleb sunglasses", data: "caleb"},
  { id: "MC11", src: "./static/loveanddeepspace/Paper17376015663.png", modal: "modal101", label: "MC Roar 2", data: "mc"},
  { id: "Caleb3", src: "./static/loveanddeepspace/Paper17376016124.png", modal: "modal102", label: "Caleb over the shoulder", data: "caleb"},
  { id: "Caleb4", src: "./static/loveanddeepspace/Paper17376018436.png", modal: "modal103", label: "Caleb Hand Pose", data: "caleb"},
  { id: "Zayne21", src: "./static/loveanddeepspace/Paper17376022567.png", modal: "modal104", label: "Zayne Peace Sign", data: "zayne"},
